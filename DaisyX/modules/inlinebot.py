...
from DaisyX.function import _deezer_dl, _ytdl, fetch_json
...
async def explore(event):     
    ...
    oof_stark = f"""**@DaisyXBot Powered By @DaisySupport_Official**
**I am an Angel.. Check what I'm capable**
...
**Example :** `@{tbot_username} google Daisy-X github`
**- Deezer Search!**
...
**Example :** `@{tbot_username} ph miaKhalifa`
**Note :** `Join` @DaisySupport_Official for help
    	"""
